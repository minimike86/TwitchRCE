...
| `!death_counter <+/-/reset>` <br/>_OR_ `!death <+/-/reset>` <br/>_OR_ `!ded <+/-/reset>` <br/>_OR_ `!dc <+/-/reset>` | Increment / decrease death count for each +/- (or reset)                                                                                                | -                                                         |
...
| `!infosec_streams`                                                                                                   | Creates custom channel point rewards _(The same outcome as stream_start event just incase the bot wasn't active when the stream_start event occurred.)_ | -                                                         |
| `!add_channel_subs` <br/>_OR_ `!streams` <br/>_OR_ `!streams`                                                        | Adds current channel subscribers to sub database table                                                                                                  | -                                                         |
